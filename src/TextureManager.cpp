...
void TextureManager::draw(const std::string& id, const int x, const int y, const double angle, const int alpha,
	const bool centered, const SDL_RendererFlip flip, glm::vec2 size)
{
	SDL_Rect srcRect;
	SDL_Rect destRect;
